...
import { CustomAccountLayoutInterface, ExpectedCustomAccountLayoutInterface } from "./account";
...
export const checkAccountDataIsValid = (
  customAccountData: CustomAccountLayoutInterface,
  expectedCustomAccountState: ExpectedCustomAccountLayoutInterface
) => {
